			...
			<main className="flex h-screen flex-col items-center justify-center bg-black px-6 py-16 sm:py-24 lg:scroll-px-28">
				...
				<div className="mx-auto max-w-md text-center">
					...
					<div className="mt-10 flex justify-center gap-x-6">
						<Link
							href="/welcome"
							className="bg-electricIndigo rounded-xl px-3 py-2 text-lg font-semibold text-white shadow-sm hover:bg-lime-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:px-3.5 sm:py-2.5 sm:text-2xl"
						>
							Go back home
						</Link>
					</div>
