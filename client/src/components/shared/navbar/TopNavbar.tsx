...
export default function Navbar() {
	return (
		<nav className="flex-between bg-baby_rich border-b-platinum shadow-slate-800/40 fixed z-50 w-full gap-5 border-b-2 p-4 sm:p-6 lg:px-12 dark:border-b-0">
			...
			<Link href="/" className="flex items-center">
				...
				<p className="h2-bold font-robotoSlab text-blue-900 dark:text-blue-200 hidden sm:block">
