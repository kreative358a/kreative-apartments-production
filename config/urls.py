...
schema_view = get_schema_view(
    openapi.Info(
        title="Kreative Apartments API",
        default_version="v1",
        description="An Apartment Management API for Real Estate",
        contact=openapi.Contact(email="kreative-apartments@hotmail.com"),
...
admin.site.site_header = "Kreative Apartments Admin"
admin.site.site_title = "Kreative Apartments Admin Portal"
admin.site.index_title = "Welcome to Kreative Apartments Admin Portal"
