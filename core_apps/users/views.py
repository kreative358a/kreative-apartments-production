...
# definiujemy zestaw uwierzytelniania
def set_auth_cookies(
    ...
    # httponly oznacza, że ​​nie są dostępne za pośrednictwem JavaScript po stronie klient
    logged_in_cookie_settings["httponly"] = False
    # plik cookie zalogowanego użytkownika
...
# widok uwierzytelniania dostawcy
